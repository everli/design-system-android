...
internal class EverliColorExtensionsTest : FunSpec(
  {
    listOf(
      ...
      EverliColor.BLUE_20 to EverliColors.Blue20,
      ...
      EverliColor.EDENRED to EverliColors.Edenred,
    ...
    listOf(
      ...
      EverliColor.BLUE_20 to R.color.blue_20,
      ...
      EverliColor.EDENRED to R.color.edenred,
      null to R.id.none,
